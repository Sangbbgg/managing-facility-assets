...
_GROUP_NODES = [
    ...
    # depth 4 — 1CC 하위
    (12, "ST",              "ST1",   6,  "신인천빛드림본부 > 발전제어 > 1단계 > 1CC > ST",                           4),
    (13, "GT",              "GT1",   6,  "신인천빛드림본부 > 발전제어 > 1단계 > 1CC > GT",                           4),
    # depth 4 — 2CC 하위
    (14, "ST",              "ST2",   7,  "신인천빛드림본부 > 발전제어 > 1단계 > 2CC > ST",                           4),
    (15, "GT",              "GT2",   7,  "신인천빛드림본부 > 발전제어 > 1단계 > 2CC > GT",                           4),
    # depth 4 — 3CC 하위
