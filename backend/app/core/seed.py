...
# ── group_nodes ────────────────────────────────────────────────────────────
# id  name              code    display_code  parent_id  full_path                                                   depth
_GROUP_NODES = [
    # depth 0
    ( 1, "신인천빛드림본부", None, None, None, "신인천빛드림본부",                                                   0),
    # depth 1
    ( 2, "발전제어",        None,    None, 1,  "신인천빛드림본부 > 발전제어",                                         1),
    ( 3, "연료전지",        "SA",    "SA", 1,  "신인천빛드림본부 > 연료전지",                                         1),
    # depth 2 — 발전제어 하위
    ( 4, "1단계",           None,    None, 2,  "신인천빛드림본부 > 발전제어 > 1단계",                                 2),
    ( 5, "2단계",           None,    None, 2,  "신인천빛드림본부 > 발전제어 > 2단계",                                 2),
    (16, "기타",            "COM1",  "COM", 4,  "신인천빛드림본부 > 발전제어 > 1단계 > 기타",                         3),
    # depth 3 — 발전제어 > 1단계 하위
    ( 6, "1CC",             None,    None, 4,  "신인천빛드림본부 > 발전제어 > 1단계 > 1CC",                           3),
    ( 7, "2CC",             None,    None, 4,  "신인천빛드림본부 > 발전제어 > 1단계 > 2CC",                           3),
    ( 8, "1단계 DCS",       "BR1",   "BR1", 4,  "신인천빛드림본부 > 발전제어 > 1단계 > 1단계 DCS",                    3),
    # depth 3 — 발전제어 > 2단계 하위
    ( 9, "3CC",             None,    None, 5,  "신인천빛드림본부 > 발전제어 > 2단계 > 3CC",                           3),
    (10, "4CC",             None,    None, 5,  "신인천빛드림본부 > 발전제어 > 2단계 > 4CC",                           3),
    (11, "2단계 DCS",       "BR2",   "BR2", 5,  "신인천빛드림본부 > 발전제어 > 2단계 > 2단계 DCS",                    3),
    (25, "기타",            "COM2",  "COM", 5,  "신인천빛드림본부 > 발전제어 > 2단계 > 기타",                         3),
    # depth 4 — 1CC 하위
    (12, "1ST",             "ST1",   "ST1", 6,  "신인천빛드림본부 > 발전제어 > 1단계 > 1CC > 1ST",                    4),
    (13, "1~2GT",           "GT1",   "GT1", 6,  "신인천빛드림본부 > 발전제어 > 1단계 > 1CC > 1~2GT",                  4),
    # depth 4 — 2CC 하위
    (14, "2ST",             "ST2",   "ST2", 7,  "신인천빛드림본부 > 발전제어 > 1단계 > 2CC > 2ST",                    4),
    (15, "3~4GT",           "GT2",   "GT2", 7,  "신인천빛드림본부 > 발전제어 > 1단계 > 2CC > 3~4GT",                  4),
    # depth 4 — 3CC 하위
    (17, "3ST",             "ST3",   "ST3", 9,  "신인천빛드림본부 > 발전제어 > 2단계 > 3CC > 3ST",                    4),
    (18, "5~6GT",           "GT3",   "GT3", 9,  "신인천빛드림본부 > 발전제어 > 2단계 > 3CC > 5~6GT",                  4),
    # depth 4 — 4CC 하위
    (19, "4ST",             "ST4",  "ST4", 10,  "신인천빛드림본부 > 발전제어 > 2단계 > 4CC > 4ST",                    4),
    (20, "7~8GT",           "GT4",  "GT4", 10,  "신인천빛드림본부 > 발전제어 > 2단계 > 4CC > 7~8GT",                  4),
    # depth 4 — 1CC 하위
    (21, "1EG",             "EG1",   "EG1", 6,  "신인천빛드림본부 > 발전제어 > 1단계 > 1CC > 1EG",                    4),
    # depth 4 — 2CC 하위
    (22, "2EG",             "EG2",   "EG2", 7,  "신인천빛드림본부 > 발전제어 > 1단계 > 2CC > 2EG",                    4),
    # depth 4 — 3CC 하위
    (23, "3EG",             "EG3",   "EG3", 9,  "신인천빛드림본부 > 발전제어 > 2단계 > 3CC > 3EG",                    4),
    # depth 4 — 4CC 하위
    (24, "4EG",             "EG4",  "EG4", 10,  "신인천빛드림본부 > 발전제어 > 2단계 > 4CC > 4EG",                    4),
]
...
async def seed_group_nodes(session: AsyncSession) -> None:
    ...
    await session.execute(text("""
        INSERT INTO group_nodes (id, name, code, display_code, parent_id, full_path, depth)
        VALUES (:id, :name, :code, :display_code, :parent_id, :full_path, :depth)
    """), [
        {"id": r[0], "name": r[1], "code": r[2], "display_code": r[3], "parent_id": r[4], "full_path": r[5], "depth": r[6]}
